...
public class RunReportsApi {
     ...
     */
    public com.squareup.okhttp.Call runReportCall(String reportName, Boolean isSelfServiceUserReport, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        localVarQueryParams.addAll(apiClient.parameterToPair("isSelfServiceUserReport", isSelfServiceUserReport));
    ...
    private com.squareup.okhttp.Call runReportValidateBeforeCall(String reportName, Boolean isSelfServiceUserReport, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        com.squareup.okhttp.Call call = runReportCall(reportName, isSelfServiceUserReport, progressListener, progressRequestListener);
        return call;
     ...
     */
    public GetReportNameResponse runReport(String reportName, Boolean isSelfServiceUserReport) throws ApiException {
        ApiResponse<GetReportNameResponse> resp = runReportWithHttpInfo(reportName, isSelfServiceUserReport);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<GetReportNameResponse> runReportWithHttpInfo(String reportName, Boolean isSelfServiceUserReport) throws ApiException {
        com.squareup.okhttp.Call call = runReportValidateBeforeCall(reportName, isSelfServiceUserReport, null, null);
     ...
     */
    public com.squareup.okhttp.Call runReportAsync(String reportName, Boolean isSelfServiceUserReport, final ApiCallback<GetReportNameResponse> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = runReportValidateBeforeCall(reportName, isSelfServiceUserReport, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<GetReportNameResponse>(){}.getType();
