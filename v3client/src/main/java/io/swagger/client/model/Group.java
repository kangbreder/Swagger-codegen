...
public class Group {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, office, staff, parent, groupLevel, clientMembers, submittedOnDate, accountNumberRequiresAutoGeneration, active, closed, notPending, center, group, activationLocalDate, transferInProgress, transferOnHold, transferInProgressOrOnHold, childGroup, activeClientMembers, pending, notActive, _new);
  }
