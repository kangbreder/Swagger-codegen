//
// GetLoansLoanIdChargesChargeIdResponse.swift
//
...
public struct GetLoansLoanIdChargesChargeIdResponse: Codable {
    ...
    public init(_id: Int?, chargeId: Int?, name: String?, chargeTimeType: GetLoanChargeTimeType?, chargeCalculationType: GetLoanChargeCalculationType?, percentage: Double?, amountPercentageAppliedTo: Double?, currency: GetLoanChargeCurrency?, amount: Float?, amountPaid: Float?, amountWaived: Float?, amountWrittenOff: Float?, amountOutstanding: Float?, amountOrPercentage: Float?, penalty: Bool?) {
        self._id = _id
