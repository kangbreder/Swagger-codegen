//
// GetLoanProductsExpenseAccountOptions.swift
//
...
public struct GetLoanProductsExpenseAccountOptions: Codable {
    ...
    public var type: GetLoanProductsExpenseType?
    ...
    public init(_id: Int?, name: String?, glCode: Int?, disabled: Bool?, manualEntriesAllowed: Bool?, type: GetLoanProductsExpenseType?, usage: GetLoanProductsLiabilityUsage?, nameDecorated: String?, tagId: GetLoanProductsLiabilityTagId?, organizationRunningBalance: Int?) {
        self._id = _id
        self.name = name
        self.glCode = glCode
