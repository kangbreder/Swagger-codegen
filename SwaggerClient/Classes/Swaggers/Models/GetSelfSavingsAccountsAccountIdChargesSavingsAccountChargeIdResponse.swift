//
// GetSelfSavingsAccountsAccountIdChargesSavingsAccountChargeIdResponse.swift
//
...
public struct GetSelfSavingsAccountsAccountIdChargesSavingsAccountChargeIdResponse: Codable {
    ...
    public init(_id: Int?, chargeId: Int?, name: String?, chargeTimeType: GetSelfSavingsChargeTimeType?, chargeCalculationType: GetSelfSavingsChargeCalculationType?, percentage: Double?, amountPercentageAppliedTo: Double?, currency: GetSelfSavingsCurrency?, amount: Int?, amountPaid: Int?, amountWaived: Int?, amountWrittenOff: Int?, amountOutstanding: Int?, amountOrPercentage: Int?, penalty: Bool?) {
        self._id = _id
