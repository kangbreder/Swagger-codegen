//
// GetSavingsAccountsSavingsAccountIdChargesSavingsAccountChargeIdResponse.swift
//
...
public struct GetSavingsAccountsSavingsAccountIdChargesSavingsAccountChargeIdResponse: Codable {
    ...
    public init(_id: Int?, chargeId: Int?, name: String?, chargeTimeType: GetChargesChargeTimeType?, chargeCalculationType: GetChargesChargeCalculationType?, percentage: Double?, amountPercentageAppliedTo: Double?, currency: GetChargesCurrencyResponse?, amount: Float?, amountPaid: Float?, amountWaived: Float?, amountWrittenOff: Float?, amountOutstanding: Float?, amountOrPercentage: Float?, penalty: Bool?) {
        self._id = _id
