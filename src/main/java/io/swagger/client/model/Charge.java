...
public class Charge {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, name, amount, currencyCode, chargeTimeType, chargeCalculation, chargePaymentMode, feeInterval, penalty, active, deleted, minCap, maxCap, account, taxGroup, loanCharge, savingsCharge, clientCharge, allowedSavingsChargeCalculationType, allowedClientChargeCalculationType, percentageOfDisbursementAmount, percentageOfApprovedAmount, feeOnMonthDay, disbursementCharge, annualFee, monthlyFee, overdueInstallment, allowedLoanChargeTime, allowedClientChargeTime, allowedSavingsChargeTime, _new);
  }
